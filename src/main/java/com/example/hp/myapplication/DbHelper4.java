...
public class DbHelper4  extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "MyDBName7.db";
    ...
    public static final String TABLE_CONTACTS="info5";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE IF EXISTS info5");
        onCreate(db);
    }
    ...
    public void addDataModel(DataModel2 d){
        ...
        db.insert("info5", null, contentValues);
        db.close();
    }
    ...
    public List<DataModel2> getAll() {
        ...
        String selectQuery = "SELECT *FROM  info5";
        SQLiteDatabase db = this.getWritableDatabase();
