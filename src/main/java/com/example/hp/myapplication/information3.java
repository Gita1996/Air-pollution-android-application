...
public class information3  extends Activity {
    TextView v;
   ...
   // ArrayList<DataModel> dataModels;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // mydb = new DbHelper4(this);
        //  dataModels2=new List<DataModel>();
       /*
        mydb.addDataModel(new DataModel("1","1","1","1","1"));
        dataModels2=  mydb.getAllDataModel();
...
/////////////////
        ...
        try {
            ...
            while ((csv_item = reader.readLine()) != null) {
                ...
                String PT= row[4];
//No2,co2,pt,date
                dataModels2.add(new DataModel2(date,time,PT));
                mydb.addDataModel(new DataModel2(date,time,PT));
