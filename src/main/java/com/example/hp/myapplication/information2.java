...
public class information2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //  dataModels2= (ArrayList<DataModel2>) mydb.getAll();
...
/////////////////
        ...
        try {
            ...
            while ((csv_item = reader.readLine()) != null) {
                ...
                String PT= row[4];
//No2,co2,pt,date
                dataModels2.add(new DataModel2(date,time,co));
                mydb.addDataModel(new DataModel2(date,time,co));
